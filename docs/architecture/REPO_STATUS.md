...
- Stage 6 browser UI: `mneme ui` serves a stdlib local dashboard that reads runtime/avatar snapshots, renders state, submits typed user input, and saves preferred camera/microphone/speaker selections without owning cognition.
